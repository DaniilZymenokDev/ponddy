...
// 		const fetch = async () => {
// 			await axios
// 				.get('https://dictionary-api-development.ponddy.com/api/v1/grammars/grammar/20', {
// 					headers: {
...
// 								paddingVertical: 8,
// 							}}>
// 							<Text style={{ color: '#969CA0' }}>{data?.sentences[0]?.trans}</Text>
// 						</View>
// 						<View
// 							style={{
// 								flexDirection: 'row',
...
// 								color='#6ACFED'
// 								size={12}></FontAwesome>
// 							<Text style={{ color: '#969CA0', fontSize: 18, marginHorizontal: 8 }}>
// 								Key words:
// 							</Text>
...
// 							onPress={() => playSound(data?.sentences[0]?.voice)}
// 						/>
// 						<Text style={{ marginLeft: 10, color: '#969CA0' }}>Pronounce from api</Text>
// 					</View>
// 					<View
// 						style={{
// 							flexDirection: 'row',
...
// 						</Text>
// 						<Text style={{ fontSize: 20 }}>{data?.sentences[0]?.segments[activeIndex]?.word}</Text>
// 					</View>
